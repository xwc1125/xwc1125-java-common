...
public class ExcelUtils<T> {
    ...
    public ExcelUtils(Class<T> clazz, String dirPath) {
        this.clazz = clazz;
     ...
     * @return 结果
     */
    public ResponseInfo exportExcel(List<T> list, String sheetName) {
     ...
     * @return 结果
     */
    public ResponseInfo importTemplateExcel(String sheetName) {
     ...
     * @return 结果
     */
    public ResponseInfo exportExcel() {
        ...
        try {
            ...
            out = new FileOutputStream(getAbsoluteFile(dirPath, filename));
            wb.write(out);
     ...
     * @param filename 文件名称
     */
    public String getAbsoluteFile(String dirPath, String filename) {
        if (!dirPath.endsWith("/")) {
            dirPath = dirPath + "/";
        }
