...
import com.xwc1125.common.util.io.exception.FileNameLengthLimitExceededException;
import com.xwc1125.common.util.io.exception.FileSizeLimitExceededException;
...
public class FileUploadUtils {
    ...
    public static final String extractFilename(MultipartFile file, String extension) {
        ...
        filename = DateUtils.FormatDate(new Date(), DateFormat.YYYY_7MM_7dd.getValue()) + "/" + encodingFilename(filename) + extension;
        return filename;
    }
    ...
    private static final String encodingFilename(String filename) {
        ...
        filename = MD5Utils.Encrypt(filename + System.nanoTime() + counter++);
        return filename;
    }
